...
MKINSTALLDIRS   := /Users/doug/Downloads/lab1/ext/freetype-2.10.0/builds/unix/./install-sh -c -d
...
PKG_CONFIG         := 
REQUIRES_PRIVATE   := 
LIBS_PRIVATE       := -lz -lbz2 -L/usr/local/Cellar/libpng/1.6.37/lib -lpng16 -lz
LIBSSTATIC_CONFIG  := -lfreetype -lz -lbz2 -L/usr/local/Cellar/libpng/1.6.37/lib -lpng16 -lz
build_libtool_libs := 
ft_version         := 23.0.17
